...
@inline function exp_sid_m8(A)
    return exp_sid_m8!(copy(A))
end
...
@inline function exp_sid_m8!(A)
    ...
    value_one=ValueOne()
    # Computation order: Bb2 Ba2 B2 Ba3 B3 Ba4 B4 Ba5 B5 Bb6 B6 Ba7 Bb7 B7 Ba8 Bb8_7 B8 Ba9 Bb9 B9 T2k11
    ...
    memslots[9] .= coeff1.*memslots[9] .+ coeff2.*memslots[3]
    # Deallocating B9 in slot 3
    return memslots[9] # Returning T2k11
end

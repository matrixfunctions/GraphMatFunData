...
@inline function exp_bbcs_m10(A)
    return exp_bbcs_m10!(copy(A))
end
...
@inline function exp_bbcs_m10!(A)
    ...
    value_one=ValueOne()
    # Computation order: Bb2 Ba2 B2 Bb3 B3 Ba5_4 B4 Bb5 B5 Ba6 Bb6 B6 Ba7 Bb7 B7 B8 B9 B10 B11 T2k13
    # Computing Bb2 = x*I+x*A
    coeff1=0.0 + 0.0im
    coeff2=0.03125 + 0.0im
    ...
    coeff2=0.0 - 0.008912493113538797im
    ...
    coeff2=0.0 + 0.04516040635859008im
    ...
    coeff1=0.0 - 0.020637762737741035im
    ...
    memslots[3] .= coeff1.*memslots[3] .+ coeff2.*memslots[2]
    # Deallocating B11 in slot 2
    return memslots[3] # Returning T2k13
end

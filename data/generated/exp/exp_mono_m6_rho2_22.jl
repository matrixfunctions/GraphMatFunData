...
@inline function exp_mono_m6_rho2_22(A)
    return exp_mono_m6_rho2_22!(copy(A))
end
...
@inline function exp_mono_m6_rho2_22!(A)
    ...
    value_one=ValueOne()
    # Computation order: B2 B3 B4 B5 B6 B7 T2k9
    ...
    memslots[1] .= coeff2.*memslots[1] .+ coeff3.*memslots[2] .+ coeff4.*memslots[3] .+ coeff5.*memslots[4] .+ coeff6.*memslots[5] .+ coeff7.*memslots[6] .+ coeff8.*memslots[7]

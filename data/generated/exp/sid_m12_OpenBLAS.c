...
void dsid_m12(double *A, const size_t n, double *output) {
    ...
    /* Computation order: Bb9_2 Bb2 Ba9_2 Ba2 B2 Bb9_3 Ba9_3 Ba3 B3 Ba9_4 Bb9_4 Ba8_3 Ba8_4 Ba4 B4 Ba8_5 Ba9_5 Bb9_5 Ba5 B5 Bb9_6 Ba8_6 Ba9_6 Bb7_4 Bb7_5 Bb7_6 Bb6_3 Bb6_4 Bb6_5 Bb6 B6 Ba8_7 Bb7 Ba7_3 Bb8_3 Bb8_4 Ba7_4 Bb8_5 Ba7_5 Ba7_6 Bb8_6 Ba7 B7 Ba8 Bb8_7 B8 Ba9 Bb9 B9 B10 B11 B12 B13 T2k15 */
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, n, n, n,
            ONE, memslots[1], n, memslots[1], n,
            ZERO, memslots[0], n);
    /* Deallocating B12 in slot 2 */

    /* Computing T2k15 with operation: lincomb */
    coeff1 = 0.0;
    coeff2 = 1.0;
    /* Smart lincomb recycle B2 */
    cblas_daxpby(n*n, coeff2, memslots[0], 1,
             coeff1, memslots[5], 1);
    /* Deallocating B13 in slot 1 */

    /* Prepare output. */
    memcpy(output, memslots[5], n*n*sizeof(*output));
    free(master_mem);
}

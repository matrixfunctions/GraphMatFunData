...
void zexp_bbcs_m8(openblas_complex_double *A, const size_t n, openblas_complex_double *output) {
    ...
    coeff1 = 0.0 + -0.08255105095096414*I;
    ...
    coeff2 = 0.0 + -0.03564997245415519*I;
    ...
    coeff2 = 0.0 + 0.18064162543436033*I;

function output = exp_mono_m11(A)
    n = size(A,1);
    I = eye(n,n);
    % Computation order: T2k2 B2 T2k3 B3 T2k4 B4 T2k5 B5 T2k6 B6 T2k7 B7 T2k8 B8 T2k9 B9 T2k10 B10 T2k11 B11 B12 T2k12 T2k14

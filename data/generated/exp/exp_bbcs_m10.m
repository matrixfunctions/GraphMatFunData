function output=exp_bbcs_m10(A)
    n=size(A,1);
    I=eye(n,n);
    ...
    coeff1=0.0 + 1i*-0.020637762737741035;
    ...
    coeff2=0.0 + 1i*-0.008912493113538797;
    ...
    coeff2=0.0 + 1i*0.04516040635859008;

...
@inline function exp_mono_m7_rho6_0(A)
    return exp_mono_m7_rho6_0!(copy(A))
end
...
@inline function exp_mono_m7_rho6_0!(A)
    ...
    memslots[1] .= coeff2.*memslots[1] .+ coeff3.*memslots[2] .+ coeff4.*memslots[3] .+ coeff5.*memslots[4] .+ coeff6.*memslots[5] .+ coeff7.*memslots[6] .+ coeff8.*memslots[7] .+ coeff9.*memslots[8]

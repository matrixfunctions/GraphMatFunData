...
@inline function exp_ps_m5(A)
    T=promote_type(eltype(A),Float64)
    A_copy=similar(A,T); A_copy .= A;
    return exp_ps_m5!(A_copy)
end
...
@inline function exp_ps_m5!(A)
    ...
    value_one=ValueOne()
    # Computation order: A2 A3 A4 P2 C1 P1 C0 P0
    ...
    # Computing P2 = x*I+x*A+x*A2+x*A3+x*A4

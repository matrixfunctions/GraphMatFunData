...
@inline function exp_bbcs_m11(A)
    T=promote_type(eltype(A),ComplexF64)
    A_copy=similar(A,T); A_copy .= A;
    return exp_bbcs_m11!(A_copy)
end
...
@inline function exp_bbcs_m11!(A)
    ...
    value_one=ValueOne()
    # Computation order: Bb2 Ba2 B2 Bb3 B3 Ba5_4 B4 Bb5 B5 Ba6 Bb6 B6 Ba7 Bb7 B7 B8 B9 B10 B11 B12 T2k14
    ...
    coeff2=0.0 - 0.0044562465567693985im
    ...
    coeff2=0.0 + 0.02258020317929504im
    ...
    coeff1=0.0 - 0.010318881368870518im
    ...
    memslots3 .= coeff1.*memslots3 .+ coeff2.*memslots1
    # Deallocating B12 in slot 1
    return memslots3 # Returning T2k14
end

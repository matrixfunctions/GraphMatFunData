...
void dexp_native_jl_rho43_2(double *A, const size_t n, double *output) {
    ...
    /* Computation order: C A2 Ua2 Va2 A4 Va3 Ua3 Ub2 Vb2 A6 Ua Va Ub3 Ub Uc U Vb3 Vb V Z X P S1 S2 S3 */

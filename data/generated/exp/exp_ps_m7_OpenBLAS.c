...
void dexp_ps_m7(double *A, const size_t n, double *output) {
    ...
    /* Computation order: B_3_1 B_0_1 B_1_1 B_2_1 A2 B_0_2 B_2_2 B_3_2 B_1_2 A3 B_2_3 B_3_3 B_0_3 B_1_3 A4 B_3_4 B_2_4 B_1_4 B_0_4 A5 P3 C2 P2 C1 P1 C0 P0 */
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, n, n, n,
            ONE, memslots[1], n, memslots[6], n,
            ZERO, memslots[0], n);
    /* Deallocating P3 in slot 2 */

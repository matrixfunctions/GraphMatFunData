...
@inline function bbcs_m6(A)
    return bbcs_m6!(copy(A))
end
...
@inline function bbcs_m6!(A)
    ...
    memslots[4] .= coeff1.*memslots[1] .+ coeff2.*memslots[4] .+ coeff3.*memslots[3] .+ coeff4.*memslots[5] .+ coeff5.*memslots[6]
    ...
    memslots[1] .= coeff1.*memslots[1] .+ coeff2.*memslots[3]

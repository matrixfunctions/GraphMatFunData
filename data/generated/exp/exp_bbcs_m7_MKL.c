...
void zexp_bbcs_m7(MKL_Complex16 *A, const size_t n, MKL_Complex16 *output) {
    ...
    coeff1.real = 0.0;
    coeff1.imag = -0.16510210190192828;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = -0.07129994490831038;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = 0.36128325086872065;

...
void dps_m12(double *A, const size_t n, double *output) {
    ...
    cblas_daxpby(n*n, coeff2, memslots[7], 1,
             coeff1, memslots[1], 1);
    /* Deallocating B_2_6 in slot 8 */

    /* Computing C1 with operation: mult */
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, n, n, n,
            ONE, memslots[1], n, memslots[9], n,
            ZERO, memslots[0], n);

...
void zexp_bbcs_m10(MKL_Complex16 *A, const size_t n, MKL_Complex16 *output) {
    ...
    coeff1.real = 0.0;
    coeff1.imag = -0.020637762737741035;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = -0.008912493113538797;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = 0.04516040635859008;

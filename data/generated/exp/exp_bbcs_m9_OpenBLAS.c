...
void zexp_bbcs_m9(openblas_complex_double *A, const size_t n, openblas_complex_double *output) {
    ...
    coeff1 = 0.0 + -0.04127552547548207*I;
    ...
    coeff2 = 0.0 + -0.017824986227077594*I;
    ...
    coeff2 = 0.0 + 0.09032081271718016*I;

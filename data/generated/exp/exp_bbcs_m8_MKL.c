...
void zexp_bbcs_m8(MKL_Complex16 *A, const size_t n, MKL_Complex16 *output) {
    ...
    coeff1.real = 0.0;
    coeff1.imag = -0.08255105095096414;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = -0.03564997245415519;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = 0.18064162543436033;

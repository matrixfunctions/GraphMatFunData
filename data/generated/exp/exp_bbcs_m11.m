function output = exp_bbcs_m11(A)
    n = size(A,1);
    I = eye(n,n);
    ...
    coeff2 = 0.0 + 1i*-0.0044562465567693985;
    ...
    coeff2 = 0.0 + 1i*0.02258020317929504;

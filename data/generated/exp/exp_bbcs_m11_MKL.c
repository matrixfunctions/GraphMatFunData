...
void zexp_bbcs_m11(MKL_Complex16 *A, const size_t n, MKL_Complex16 *output) {
    ...
    coeff1.real = 0.0;
    coeff1.imag = -0.010318881368870518;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = -0.0044562465567693985;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = 0.02258020317929504;

function output=exp_bbcs_m7(A)
    ...
    coeff1=0.0 + 1i*-0.16510210190192828;
    ...
    coeff2=0.0 + 1i*-0.07129994490831038;
    ...
    coeff2=0.0 + 1i*0.36128325086872065;

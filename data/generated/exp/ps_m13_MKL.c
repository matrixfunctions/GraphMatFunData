...
void dps_m13(double *A, const size_t n, double *output) {
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, n, n, n,
            ONE, memslots[0], n, memslots[9], n,
            ZERO, memslots[8], n);
    /* Deallocating A3 in slot 10 */
    ...
    /* Deallocating A7 in slot 10 */

    /* Computing P6 with operation: lincomb */
    coeff1 = 1.4064725544496498e-75;
    coeff2 = 1.0;
    /* Smart lincomb recycle B_6_7 */
    cblas_daxpby(n*n, coeff1, memslots[8], 1,
             coeff2, memslots[5], 1);

    /* Computing C5 with operation: mult */
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, n, n, n,
            ONE, memslots[5], n, memslots[8], n,
            ZERO, memslots[0], n);
    /* Deallocating P6 in slot 6 */
    ...
    cblas_daxpby(n*n, coeff2, memslots[4], 1,
             coeff1, memslots[0], 1);
    /* Deallocating B_5_7 in slot 5 */

    /* Computing C4 with operation: mult */
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, n, n, n,
            ONE, memslots[0], n, memslots[8], n,
            ZERO, memslots[4], n);
    /* Deallocating P5 in slot 1 */

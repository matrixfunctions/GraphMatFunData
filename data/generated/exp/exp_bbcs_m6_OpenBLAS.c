...
void zexp_bbcs_m6(openblas_complex_double *A, const size_t n, openblas_complex_double *output) {
    ...
    /* Computation order: Bb2 Ba2 B2 Bb3 B3 Bb7_3 Bb7_4 Ba6_2 Ba6_3 Ba6_4 Ba5_3 Ba5_4 Bb5_4 Bb6_2 Bb6_3 Bb6_4 Ba7_3 Ba7_4 B4 Bb5 B5 Ba6_5 Ba6 Bb6_5 Bb6 B6 Bb7_5 Ba7_5 Ba7 Bb7 B7 T2k9 */
    ...
    coeff1 = 0.0 + -0.33020420380385657*I;
    ...
    coeff2 = 0.0 + -0.14259988981662075*I;
    ...
    coeff2 = 0.0 + 0.7225665017374413*I;
    ...
    cblas_zaxpby(n*n, &coeff2, memslots[8], 1,
             &coeff1, memslots[6], 1);

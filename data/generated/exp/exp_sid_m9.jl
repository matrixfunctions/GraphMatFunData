...
@inline function exp_sid_m9(A)
    return exp_sid_m9!(copy(A))
end
...
@inline function exp_sid_m9!(A)
    ...
    value_one=ValueOne()
    # Computation order: Bb2 Ba2 B2 Ba3 B3 Ba4 B4 Ba5 B5 Bb6 B6 Ba7 Bb7 B7 Ba8 Bb8_7 B8 Ba9 Bb9 B9 B10 T2k12
    ...
    # Computing T2k12 = x*B7+x*B10
    coeff1=0.0
    coeff2=1.0
    # Smart lincomb recycle B7
    memslots[9] .= coeff1.*memslots[9] .+ coeff2.*memslots[1]
    # Deallocating B10 in slot 1
    return memslots[9] # Returning T2k12
end

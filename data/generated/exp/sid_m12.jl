...
@inline function sid_m12(A)
    return sid_m12!(copy(A))
end
...
@inline function sid_m12!(A)
    ...
    value_one=ValueOne()
    # Computation order: Bb2 Ba2 B2 Ba3 B3 Ba4 B4 Ba5 B5 Bb6 B6 Ba7 Bb7 B7 Ba8 Bb8_7 B8 Ba9 Bb9 B9 B10 B11 B12 B13 T2k15
    ...
    # Computing T2k15 = x*B2+x*B13
    coeff1=0.0
    coeff2=1.0
    # Smart lincomb recycle B2
    memslots[4] .= coeff1.*memslots[4] .+ coeff2.*memslots[2]
    # Deallocating B13 in slot 2
    return memslots[4] # Returning T2k15
end

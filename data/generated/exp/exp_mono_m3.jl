...
@inline function exp_mono_m3(A)
    return exp_mono_m3!(copy(A))
end
...
@inline function exp_mono_m3!(A)
    ...
    value_one=ValueOne()
    # Computation order: B2 B3 B4 T2k6
    ...
    memslots[1] .= coeff2.*memslots[1] .+ coeff3.*memslots[2] .+ coeff4.*memslots[3] .+ coeff5.*memslots[4]

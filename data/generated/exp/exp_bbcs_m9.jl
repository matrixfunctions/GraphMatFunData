...
@inline function exp_bbcs_m9(A)
    T=promote_type(eltype(A),ComplexF64)
    A_copy=similar(A,T); A_copy .= A;
    return exp_bbcs_m9!(A_copy)
end
...
@inline function exp_bbcs_m9!(A)
    ...
    value_one=ValueOne()
    # Computation order: Bb2 Ba2 B2 Bb3 B3 Ba5_4 B4 Bb5 B5 Ba6 Bb6 B6 Ba7 Bb7 B7 B8 B9 B10 T2k12
    ...
    coeff2=0.0 - 0.017824986227077594im
    ...
    coeff2=0.0 + 0.09032081271718016im
    ...
    coeff1=0.0 - 0.04127552547548207im
    ...
    return memslots3 # Returning T2k12
end

...
void zexp_bbcs_m6(MKL_Complex16 *A, const size_t n, MKL_Complex16 *output) {
    ...
    coeff1.real = 0.0;
    coeff1.imag = -0.33020420380385657;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = -0.14259988981662075;
    ...
    coeff1.imag = 0.0;
    coeff2.real = 0.0;
    coeff2.imag = 0.7225665017374413;

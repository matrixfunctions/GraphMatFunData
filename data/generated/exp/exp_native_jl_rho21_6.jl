...
@inline function exp_native_jl_rho21_6(A)
    return exp_native_jl_rho21_6!(copy(A))
end
...
@inline function exp_native_jl_rho21_6!(A)
    ...
    value_one=ValueOne()
    # Computation order: C A2 A4 A6 Ub3 Ub Uc U Vb3 Vb V Z X P S1 S2
    # Computing C = x*A+x*I
    coeff1=0.25
    coeff2=0.0
    ...
    return memslots[2] # Returning S2
end

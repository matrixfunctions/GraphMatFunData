...
@inline function sid_m7(A)
    return sid_m7!(copy(A))
end
...
@inline function sid_m7!(A)
    ...
    memslots[9] .= coeff1.*memslots[1] .+ coeff2.*memslots[2] .+ coeff3.*memslots[3] .+ coeff4.*memslots[4] .+ coeff5.*memslots[5] .+ coeff6.*memslots[7] .+ coeff7.*memslots[9]
    ...
    memslots[7] .= coeff1.*memslots[1] .+ coeff2.*memslots[2] .+ coeff3.*memslots[3] .+ coeff4.*memslots[4] .+ coeff5.*memslots[5] .+ coeff6.*memslots[7]
    # Computing B8 with operation: mult
    mul!(memslots[6],memslots[9],memslots[7])
